...
HD_PWD=C:/Users/TAN/Desktop/SM/SM.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log StreamingMultiprocesser.vds -m64 -mode batch -messageDb vivado.pb -notrace -source StreamingMultiprocesser.tcl
