...
HD_PWD=C:/Users/TAN/Desktop/SM/SM.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log StreamingMultiprocesser.vdi -applog -m64 -messageDb vivado.pb -mode batch -source StreamingMultiprocesser.tcl -notrace
